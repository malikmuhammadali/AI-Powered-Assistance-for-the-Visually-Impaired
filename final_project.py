...
# Streamlit app UI
st.set_page_config(page_title="AI-Powered Assistance for the Visually Impaired", page_icon="🌟", layout="wide")

st.sidebar.title("AI-Powered Assistance for the Visually Impaired")
...
if task == "Scene Understanding":
    st.title("AI-Powered Assistance for the Visually Impaired")
